...
main_function 	:	type MAIN LB_ROUND RB_ROUND LB_CURLY statements RB_CURLY
...
int main(){
    cout<<"Step 1: Lexical Analysis"<<endl<<endl;
	...
	SemanticAnalysis semantic(ParseTreeRoot);
	semantic.errors();		// Print success message or the errors in semantic analysis(if any)

	cout<<"\nStep 3: Code Generation\n"<<endl;

	MIPSCode mips;
	mips.generateCode(ParseTreeRoot);
